# -*- coding: utf-8 -*-
"""
Created on Tue Jan 28 19:09:24 2020
...
class Warping:
    ...
    def birdEye(self, img, leftShift=0):
        ...
        :param leftShift: 
        :return: 
        use cv2.getPerspective and wrapPerspective
        """
        ######################## Your code #############################
...
class Drawing:
    ...
    def addPolygon(srcShape, lFit, rFit, stepCount=10, color=(0, 255, 0)):
        ...
        xl = utils.funcSpace(argSpace=y, fitParams=lFit)
        xr = utils.funcSpace(argSpace=y, fitParams=rFit)
    ...
    def addLine(src, fit, color, stepCount=10, thickness=2):
        ...
        if fit is not None:
            ...
            x = utils.funcSpace(argSpace=y, fitParams=fit)
